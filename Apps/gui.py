...
button8 = Button(frame, text=8, height=4, width=9, font=35, command=lambda: press(9))
...
plus = Button(frame, text='+', height=4, width=9, font=35, command=lambda: press('+'))
plus.grid(row=0, column=3)

minus = Button(frame, text='-', height=4, width=9, font=35, command=lambda: press('-'))
minus.grid(row=1, column=3)

plus = Button(frame, text='*', height=4, width=9, font=35, command=lambda: press('*'))
plus.grid(row=2, column=3)

divide = Button(frame, text='/', height=4, width=9, font=35, command=lambda: press('/'))
divide.grid(row=3, column=3)

equal = Button(frame, text='=', height=4, width=9, font=35,command=equals)
equal.grid(row=3, column=2)

decimal = Button(frame, text='.', height=4, width=9, font=35, command=lambda: press('.'))
decimal.grid(row=3, column=1)

clear = Button(window, text='Clear', height=4, width=12, font=38, command=clear)
clear.pack()
